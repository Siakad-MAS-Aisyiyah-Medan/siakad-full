...
import { unwrapData, unwrapPaginated } from '@/shared/services/apiHelpers';
...
export const PPDB_STATUS_LABELS = {
  ...
  draft: 'Belum Mengirim',
  revision: 'Revisi',
  submitted: 'Sudah Mengirim',
  verified: 'Sudah Mengirim',
  accepted: 'Diterima',
  rejected: 'Ditolak',
  diajukan: 'Sudah Mengirim',
  revisi: 'Revisi',
  terverifikasi: 'Sudah Mengirim',
  diterima: 'Diterima',
  ditolak: 'Ditolak',
