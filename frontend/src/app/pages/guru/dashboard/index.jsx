...
const cards = [
  { label: 'Total Murid', value: '1', icon: GraduationCap, gradient: 'linear-gradient(135deg, #059669 0%, #10b981 100%)', shadow: 'rgba(5, 150, 105, 0.3)' },
  { label: 'Total Guru', value: '1', icon: Users, gradient: 'linear-gradient(135deg, #3b82f6 0%, #60a5fa 100%)', shadow: 'rgba(59, 130, 246, 0.3)' },
  { label: 'Mata Pelajaran', value: '0', icon: ClipboardList, gradient: 'linear-gradient(135deg, #f59e0b 0%, #fbbf24 100%)', shadow: 'rgba(245, 158, 11, 0.3)' },
  { label: 'Total Kelas', value: '0', icon: BookOpen, gradient: 'linear-gradient(135deg, #8b5cf6 0%, #a78bfa 100%)', shadow: 'rgba(139, 92, 246, 0.3)' },
];
...
const announcements = [
  ...
  { title: 'Pembagian Raport Semester Genap', date: '15/05/2026' },
];
          ...
          <div style={{ padding: '0.25rem 0.5rem' }}>
            {announcements.map((item) => (
              ...
              >
                ...
                <span style={{ fontSize: '0.78rem', color: '#94a3b8', whiteSpace: 'nowrap' }}>{item.date}</span>
              </div>
            ))}
          </div>
