...
export default function AbsensiFilterForm({ meta, kelasList, mapelList, loading, onChange, onSubmit }) {
  return (
    <form onSubmit={onSubmit} className="form-panel glass p-6">
      <h3 className="font-semibold mb-4">Pilih Konteks Absensi</h3>
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="input-group">
          <label>Tanggal *</label>
          <input type="date" name="tanggal" value={meta.tanggal} onChange={onChange} required />
        </div>
        <div className="input-group">
          <label>Jam Mulai *</label>
          <input type="time" name="jam_mulai" value={meta.jam_mulai} onChange={onChange} required />
        </div>
        <div className="input-group">
          <label>Jam Selesai *</label>
          <input type="time" name="jam_selesai" value={meta.jam_selesai} onChange={onChange} required />
        </div>
        <div className="input-group">
