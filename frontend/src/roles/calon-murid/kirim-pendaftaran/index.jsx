...
import { fetchMyRegistration, submitPendaftaran } from '@/shared/services/ppdb.service';
import { calculateFormulirProgress } from '@/shared/ppdb/utils/ppdbWizardValidation';
import { UPLOAD_BERKAS_ITEMS } from '@/shared/ppdb/config/calonMuridNav';
import { confirmAction, toastSuccess, toastValidation, toastError } from '@/shared/hooks/useConfirm';
