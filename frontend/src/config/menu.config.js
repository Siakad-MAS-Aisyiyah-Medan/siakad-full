...
export const menuByRole = {
  ...
  kepsek: [
    ...
    { iconKey: 'User', label: 'Profil Saya', path: '/kepala-sekolah/profil-saya', permission: 'manage_profil_pribadi' },
  ...
  guru: [
    ...
    { iconKey: 'User', label: 'Profil Saya', path: '/guru/profil-saya', permission: 'manage_profil_pribadi' },
  ...
  siswa: [
    ...
    { iconKey: 'User', label: 'Profil Saya', path: '/siswa/profil-saya', permission: 'manage_profil_pribadi' },
