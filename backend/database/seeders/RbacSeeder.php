...
class RbacSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $menus = [
            ...
            ['permission_key' => 'view_laporan', 'icon_key' => 'ClipboardList', 'label' => 'Laporan Absensi Murid', 'path' => '/kepsek/laporan-absensi', 'sort_order' => 40],
            ['permission_key' => 'view_laporan', 'icon_key' => 'FileText', 'label' => 'Laporan Nilai Murid', 'path' => '/kepsek/laporan-nilai', 'sort_order' => 50],
